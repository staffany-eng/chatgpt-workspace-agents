...
for (const text of [
  ...
  "nurtureany-sales-bot-${deploySha}.sha",
  "sha-mismatch",
  "origin/main",
  "gcloud",
  "compute",
...
for (const text of [
  ...
  "NURTUREANY_INBOUND_ALERT_CHANNEL_IDS",
  "NURTUREANY_STANDUP_AUDIT_CHANNEL_IDS",
  "MAX_CONTEXT_MESSAGES = 10",
...
for (const text of [
  ...
  "test_inbound_alert_extraction_requires_configured_channel",
  "test_inbound_alert_extraction_reads_safe_alerts_and_redacts",
  "test_inbound_alert_extraction_auto_joins_configured_public_channel",
...
for (const text of [
  ...
  "slack-inbound-alert:configured-channel-ids-missing",
