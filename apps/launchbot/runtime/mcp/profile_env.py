...
def load_profile_env(profile_name: str = "launchbot") -> None:
    """Load profile .env for Hermes MCP children, which may start with sanitized env."""
    explicit_paths = [
        os.environ.get("LAUNCHBOT_PROFILE_ENV", "").strip(),
