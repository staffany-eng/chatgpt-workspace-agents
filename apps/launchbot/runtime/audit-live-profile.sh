...
cmp -s "$APP_ROOT/runtime/update-app-from-repo.sh" "$PROFILE_DIR/scripts/launchbot-update-app-from-repo.sh" || fail "profile-drift:repo-update-script"
cmp -s "$APP_ROOT/runtime/apply-app-update.sh" "$PROFILE_DIR/scripts/launchbot-apply-app-update.sh" || fail "profile-drift:repo-update-apply-script"
cmp -s "$APP_ROOT/runtime/sync-skill-to-repo.sh" "$PROFILE_DIR/scripts/launchbot-sync-skill-to-repo.sh" || fail "profile-drift:skill-sync-script"
cmp -s "$APP_ROOT/runtime/apply-skill-sync.sh" "$PROFILE_DIR/scripts/launchbot-apply-skill-sync.sh" || fail "profile-drift:skill-sync-apply-script"
