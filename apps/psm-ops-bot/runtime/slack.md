...
- PCO tracking checks must use `search_pco_tickets` before saying no PCO ticket exists. Exact Slack-thread lookup alone is not enough because manually-created board tickets may omit Slack source links.
