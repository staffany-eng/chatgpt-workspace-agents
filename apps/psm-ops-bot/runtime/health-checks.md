...
- Slack bot token has `files:write` before geocode TSV upload is used in production; missing scope blocks geocode output instead of pasting raw coordinates.
