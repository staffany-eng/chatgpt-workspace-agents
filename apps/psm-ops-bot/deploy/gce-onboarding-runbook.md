...
8. Ask one geocode question with explicit address rows and verify `psm_google_geocode.geocode_slack_addresses` returns address, latitude, longitude, `geocode_status`, and formatted address without printing the API key.
