...
- Sync mode: `md-only`
- Notion target: `TBD`
- Suggested sync command (new PRD page in Notion DB):
  - `SKILL_DIR="pantheon/apps/grimoire/catalog/shared/staffany-product-delivery-workflow" && node "$SKILL_DIR/scripts/sync-prd-notion.mjs" --database <NOTION_DATABASE_ID_OR_URL> --title "PRD - Manual Overtime Feature" --file outputs/prd/2026-04-27-manual-overtime-feature-prd.md --mode replace`
