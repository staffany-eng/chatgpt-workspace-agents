...
- runtime health/audit/watchdog/cloud-doctor scripts, Slack access repair script, HubSpot Task reminder scripts, and the Sales WhatsApp report runner script to the live profile `scripts/`
