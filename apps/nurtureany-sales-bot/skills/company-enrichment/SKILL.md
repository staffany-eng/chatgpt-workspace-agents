...
- Level 5: Lusha search. Search by scoped company/domain first. If Lusha returns zero and the artifact has public LinkedIn person URLs, run the Lusha LinkedIn-URL candidate path before marking Level 5 done; append it with `source="lusha_linkedin_url_search"`.
