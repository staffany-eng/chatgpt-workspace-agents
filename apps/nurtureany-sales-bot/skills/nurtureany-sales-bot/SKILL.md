...
25. Promoting outdated, archive, or copy-file sales guidance over current HubSpot truth or the maintained best-practices reference.
26. Treating Rev planning targets as actual sales or revenue performance.
27. Answering `new ARR` without choosing and stating signed converted ARR, paid converted ARR, or new MRR movement annualized.
28. Routing direct QO questions like `my QO this month` through Friday review instead of `build_sales_metric_actuals_query`.
