...
- Direct owner/team/date QO prompts should use this BigQuery revenue-metric path, not `build_friday_sales_review`. Resolve the owner/team scope first, then query aggregate `qo_set`.
