            ...
            return {
                "values": [
                    ...
                    [
                        ...
                        "daily_nurture, pre_demo, event_followup, warm_activity",
                        "Hi {{first_name}}, thought of {{company_name}} because we may be able to support your venue or feature your team. {{message_hook}} Open to exploring if this is useful?",
                        ...
                        "speaker, venue, simple-meal, leaders-lounge, happy-hr-hour, outlet-support, buy-product, long-queue, boss, hr",
                        "decision_maker, owner, founder, boss, hr",
                        "skills/nurtureany-sales-bot/references/sales-best-practices.md",
                        "",
                        "Use as Support, not Support Network. Boss variant: Leaders Lounge speaker/venue/simple meal with 1-2 bosses. HR variant: Happy HR Hour speaker/venue/simple meal with 1-2 HRs. Verify real opportunity and do not fabricate events or support.",
                        "2026-05-15",
                        "",
                        "nurtureany_packet",
                    ],
