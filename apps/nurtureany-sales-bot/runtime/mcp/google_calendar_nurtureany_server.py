...
def _load_json(path) -> dict[str, Any]:
    return _google_load_json(path, "Google Calendar", GoogleCalendarError)
...
def _blocked(message: str, scope: dict[str, Any] | None = None) -> dict[str, Any]:
    return blocked_response(message, "Google Calendar", scope)
...
def _validate_scope(payload: dict[str, Any]) -> None:
    _google_validate_scope(payload, {CALENDAR_READONLY_SCOPE, CALENDAR_BROAD_SCOPE}, "Google Calendar", GoogleCalendarError)


def _client_credentials(payload: dict[str, Any]) -> tuple[str, str]:
    return _google_client_credentials(payload, _client_secret_file(), "Google Calendar", GoogleCalendarError)
