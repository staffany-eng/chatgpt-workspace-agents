...
- Direct QO prompt smoke checks, such as `what is Jeremy's QO in April`, plan owner/team scope resolution plus `fct_sales_points.qo_set`; they do not plan `build_friday_sales_review` unless the prompt asks for Friday review or tactical pause context.
