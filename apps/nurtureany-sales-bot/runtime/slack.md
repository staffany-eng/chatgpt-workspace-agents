...
- Daily nurture and reminder automation are disabled pending refinement. Do not install a scheduled 09:00 daily nurture cron, scheduled noon reminder cron, or advertise a ready Jeremy daily-pack workflow. If someone asks for this workflow, answer that it needs confirmation before runtime use and ask what scope/output should be refined.
